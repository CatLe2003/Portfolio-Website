                  ...
                  <Container>
                      <Row>
                          <Col lg={7} xs={12}>
                              <div className="hero-text">
                                  <div className="hero-title-wrap d-flex align-items-center mb-4">
                                      <Image src="images/happy-bearded-young-man.jpg" className="avatar-image avatar-image-large img-fluid" alt=""/>
                          ...
                          <Col lg={5} xs={12} className="position-relative">
                              ...
                              <Image src="images/portrait-happy-excited-man-holding-laptop-computer.png" className="hero-image img-fluid" alt=""/>
                          </Col>
